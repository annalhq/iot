...
export default function AlarmsPage() {
  ...
  const filteredAlarms =
    filter === "All"
      ? alarmData
      : alarmData.filter((d) => d.noiseLevel === filter);
          ...
          >
            ...
            <tbody>
              {THRESHOLDS.map((t, idx) => {
                const Icon = t.icon;
                const isAlarm = ["Loud", "Very Loud", "Hazardous"].includes(
                  t.level,
                );
                return (
                  <tr
                  ...
                  >
                    ...
                    >
                      {t.analogMin}–
                      {t.analogMax === 1023 ? "1023+" : t.analogMax}
                    </td>
                    {/* Description */}
                    <td
                      style={{
            ...
            return (
              <button
                ...
                style={{
                  ...
                  borderRadius: 9,
                  border: active
                    ? `1px solid ${cfg ? cfg.border : "rgba(139,92,246,0.3)"}`
                    : "1px solid var(--border)",
                  background: active
                    ? cfg
                      ? cfg.bg
            ...
            >
              ...
              <tbody>
                {filteredAlarms.slice(0, 60).map((row, idx) => {
                  ...
                  const dbEst = THRESHOLDS.find(
                    (t) => t.level === row.noiseLevel,
                  );
                  return (
                    <tr
                      key={idx}
